...
:END:
- exported directories are compressed to =.tz= (tar.zst) archives.
#+name: meta-pack
#+begin_src sh :async
  pushd o/x
...
#+RESULTS: meta-pack
| ~/shed/src/meta/o/x | ~/shed/src/meta |
| ~/shed/src/meta     |                 |
...
#+RESULTS: meta-gen-rust-docs
| ~/shed/src/rlib  | ~/shed/src |
| ~/shed/src       |            |
| ~/shed/src/tenex | ~/shed/src |
| ~/shed/src       |            |
| ~/shed/src/shed  | ~/shed/src |
| ~/shed/src       |            |
...
#+begin_src emacs-lisp :async
  (let ((x "o/x/")
        (rh "/ssh:dmz:dmz/w/")
        (files '("m.html" "n.html" "index.html" "cv.html")))
    (copy-file x (concat rh "x/") 1)
    (dolist (f files)
      (copy-file (concat x "html/" f) rh 1)))
#+end_src
...
#+begin_src elisp :async
(copy-file "o/docs" "/ssh:dmz:dmz/w/docs")
#+end_src

#+RESULTS: meta-deploy-rust-docs
: 13e5accdf507318e1ec6965fe92179b1
*** clean
#+name: meta-clean
...
: b08e1a374d0150e0f8608c817682d69f

#+name: meta-readme-commit
#+begin_src elisp
  (let ((default-directory (expand-file-name "~/shed/src")))
    (dolist (src (list "shed" "rlib" "tenex" "babel" "cfg"))
      (let ((default-directory (expand-file-name src)))
        (vc-hg-command "*hg-cmd*" 'async nil "ci" "-m" "readme.org update"))))
#+end_src
...
#+BEGIN_export html
<script id="asciicast-445161" src="https://asciinema.org/a/445161.js" async></script>
#+END_export
** Overview
:PROPERTIES:
