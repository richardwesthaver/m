...
#+SETUPFILE: ox.setup
#+CATEGORY: metas
#+CALL: cp-f("o/x/html/m.html", "/ssh:dmz:dmz/w/")
#+CALL: cp-f("o/x/html/n.html", "/ssh:dmz:dmz/w/")
#+CALL: cp-f("o/x/html/index.html", "/ssh:dmz:dmz/w/")
#+RESULTS:
#+CALL: load-file("pub.el") :results silent
* meta
:PROPERTIES:
