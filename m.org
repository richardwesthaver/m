...
| name    | meta         |
| status  | ALPHA        |
| rev     | [[https://hg.rwest.io/meta/rev/2928a8220b35][2928a8220b35]] |
| updated | 30 hours ago |
|---------+--------------|
#+TBLFM: @4$2='(let ((rev (org-sbe "hg-rev"))) (concat "[[https://hg.rwest.io/" @2 "/rev/" rev "][" rev "]]"))
#+TBLFM: @5$2='(org-sbe "hg-log-age")

  #+CALL: shc-hg-summary() :eval yes
  #+RESULTS:
  : parent: 69:2928a8220b35 tip
  :  more org-sbe and fixed org-info-js
  : branch: default
  : commit: 2 modified
  : update: (current)
  : M index.org
...
| index.org  | 4.4K | 2021-11-14-19:46 |
| m.org      | 34K  | 2021-11-15-02:05 |
...
#+name: meta-val
#+begin_src emacs-lisp :results value :var tbl=meta-tbl idx=0 :exports none
