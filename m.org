...
#+name: meta-make-tbl
#+begin_src emacs-lisp :results value :val src="" :exports results
  (let* ((name (org-sbx org-current-heading-title))
         (rev (org-sbx hg-rev (path (concat "/home/ellis/shed/src/" name))))
         (revf (concat "[[https://hg.rwest.io/" name "/rev/" rev "][" rev "]]"))
         (age (org-sbx hg-log-age)))
    `(("key" "val") hline
      ("name" ,name)
      ("version" "alpha-0.1")
      ("rev" ,revf)
...
| name    | meta         |
| version | alpha-0.1    |
| rev     | [[https://hg.rwest.io/meta/rev/10f2ff7e9aba][10f2ff7e9aba]] |
| update  | 18 hours ago |
...
#+end_src
#+name: meta-files
#+begin_src emacs-lisp :colnames yes :hlines yes :var ft=_files :exports results :results table
ft
#+end_src
...
| m.org      | 36K  | 2021-11-17-00:40 |
| n.org      | 229K | 2021-11-14-17:37 |
| o          | 90   | 2021-11-17-00:36 |
...
**** readme-gen                                                 :noexport:
:PROPERTIES:
:CUSTOM_ID: meta-prod-readme-gen
:END:
...
| name    | babel        |
| version | alpha-0.1    |
| rev     | [[https://hg.rwest.io/babel/rev/edadbeb26482][edadbeb26482]] |
| update  | 18 hours ago |
...
| name    | cfg          |
| version | alpha-0.1    |
| rev     | [[https://hg.rwest.io/cfg/rev/c007489fa526][c007489fa526]] |
| update  | 18 hours ago |
...
| name    | shed         |
| version | alpha-0.1    |
| rev     | [[https://hg.rwest.io/shed/rev/1306f8727d53][1306f8727d53]] |
| update  | 18 hours ago |
...
| name    | rlib         |
| version | alpha-0.1    |
| rev     | [[https://hg.rwest.io/rlib/rev/e5c6ab761759][e5c6ab761759]] |
| update  | 18 hours ago |
...
| name    | tenex        |
| version | alpha-0.1    |
| rev     | [[https://hg.rwest.io/tenex/rev/948ac0a0280a][948ac0a0280a]] |
| update  | 18 hours ago |
