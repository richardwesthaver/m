...
** tutorials
*** DONE tokio tutorial                                             :async:
CLOSED: [2020-11-21 Sat 01:07] SCHEDULED: <2020-11-02 Mon>
:LOGBOOK:
- state "DONE"       from "READ"       [2020-11-21 Sat 01:07]
- state "READ"       from              [2020-10-31 Sat 20:47]
:END:
...
*** DONE [[https://os.phil-opp.com/][Writing an OS in Rust]]                                         :os:
CLOSED: [2020-11-27 Fri 18:49]
:LOGBOOK:
- state "DONE"       from "RESEARCH"   [2020-11-27 Fri 18:49]
- state "RESEARCH"   from              [2020-11-19 Thu 15:41]
:END:
...
*** DONE [[https://doc.redox-os.org/book/][redox-os book]] and compare to Linux Kernel                     :os:
CLOSED: [2020-11-21 Sat 00:47]
:LOGBOOK:
- state "DONE"       from "RESEARCH"   [2020-11-21 Sat 00:47]
- state "RESEARCH"   from              [2020-11-17 Tue 19:56]
:END:
our primary curiosities lay within architecture
- Boot process
...
had some TODO sections, may be worth revisiting this in the next few months or even offering to contribute.
