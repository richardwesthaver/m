...
* The Database Engine
As mentioned previously I want to use [[https://rocksdb.org/][RocksDB]] as an information
storage engine to preserve /Documents/, so figured It would be a good
idea to make a post documenting my first experiences with it. :)
